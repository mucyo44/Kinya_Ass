...
* Comment the following line on the initial run:
...
Upload your own `.wav` files into the `audio/` folder or record with `main.py`. Examples:
...
**MUCYO Honorine**
📧 Email: [honorinemucyo4b@gmail.com](mailto:honorinemucyo4b@gmail.com)
🔍 GitHub: [mucyo44](https://github.com/mucyo44)
